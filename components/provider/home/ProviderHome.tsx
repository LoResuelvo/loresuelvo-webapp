...
export default function ProviderHome({ session, categoryName, workRequests, scheduledJobs, metrics }: ProviderHomeProps) {
  return (
    <div className="min-h-screen bg-brand-neutral/30 flex font-sans text-brand-primary">
      <ProviderSidebar />
      <div className="flex-1 flex flex-col min-w-0">
        <ProviderHeader session={session} categoryName={categoryName} />
