    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between">
          ...
          <p data-field="last-message-at" className="text-[11px] text-slate-400">{lastMessageAt}</p>
        </div>
        <p data-field="last-message" className="text-[12px] text-slate-500 truncate">{lastMessage}</p>
      </div>
      {pending && (
